...
This project is licensed under the MIT License - see the [LICENSE.TXT](https://github.com/fauxtix/EdamanApiWithFluentUI/blob/master/EdamanFluentApi/LICENSE.txt) file for details.
