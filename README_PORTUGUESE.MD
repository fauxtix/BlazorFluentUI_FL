...
O **EdamanApiWithFluentUI** é uma aplicação web, que utiliza a API do Edaman para fornecer funcionalidade de <u>pesquisa de receitas</u>, e acesso a uma <u>base de dados abrangente de alimentos</u.
